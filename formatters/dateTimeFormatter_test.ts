...
test({
  ...
  fn() {
    assertDtf('HH:mm:ss:SSSa YYYY-MMMM-DD', 
      new Date('2020-06-09T23:59:59.999'), 
      '11:59:59:999pm 2020-June-09');
    assertDtf('hh:mm:ss:SSa YYYY-MMM-DD dddd', 
      new Date('2020-06-09T23:59:59.999'), 
      '23:59:59:99pm 2020-Jun-09 Tuesday');
    assertDtf('hh:mm:ss:SSa ddd YYYY-MMMM-DD', 
      new Date('2020-12-09T23:59:59.999'), 
      '23:59:59:99pm Wed 2020-December-09');
    assertDtf('hh:mm:ss:S dddd YY-MMM-D', 
      new Date('2020-12-09T23:59:59.999'), 
      '23:59:59:9 Wednesday 20-Dec-9');
    assertDtf('Time: hh:mm:ss:S Other: dddd YY-MMM-D', 
      new Date('2020-12-09T23:59:59.999'), 
